...
let ImgPowered = require('../../images/dummy-powertag.png');
...
// let internalMovable = ['text', 'shape', 'image', 'media']
// let externalMovable = ['text', 'shape', 'image', 'media']
// let internalSelectable = ['text', 'shape', 'image', 'media']
// let externalSelectable = ['text', 'shape', 'image', 'media']
// let internalRotatable = []
// let externalRotatable = []
...
class CanvasSection extends React.Component<IProps, IState> {
  ...
  public componentDidMount() {
    ...
    fabric.util.addListener(fabricCanvas.upperCanvasEl, "click", function (e) {
  ...
  handleChange = () => {
    if (uploadImage) {
      ...
      fabric.Image.fromURL(this.props.template.uploadedImage, (img) => {
        active_obj.getObjects().forEach(object => fabricCanvas.remove(object));
  ...
  public render() {
    ...
    setTimeout(() => {
      ...
      if (this.props.template.sendToDummy && this.props.template.currentAccount) {
        this.sendToDummy();
      }
